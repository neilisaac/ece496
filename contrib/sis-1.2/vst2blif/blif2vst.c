...
/*                                                                      *
 * These are the tests used in the tokenizer, please refer to the graph *
 ...
 * of gates that matches up the given name, if      *
 * ther is no match a null pointer is returned      *
 *                                                  *
 * Input :                                          *
 *     name = name to match                         *
 * Ouput :                                          *
