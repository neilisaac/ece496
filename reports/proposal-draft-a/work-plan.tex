...
\begin{itemlist}
	\item Overlay FPGA implementation overhead \
		\begin{itemlist}
			...
			\item Risk Mitigation strategies: \
				...
				\end{itemlist}
		\end{itemlist}
	\item Unbalanced timing \
		\begin{itemlist}
			\item Logic cells in the overlay FPGA would idealy be arranged in a perfect grid, but we expect that the placement algorithm will not produce this arrangement on the physical FPGA.
