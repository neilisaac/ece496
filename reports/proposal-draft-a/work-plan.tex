...
\begin{itemlist}
	...
	\item Hardware \
		\begin{itemlist}
			\item FPGA development board - Xilinx Virtex 5 from supervisor
			\item Host computer - personal laptops
			\item Serial cable and USB adapter - available at electronics stores
		\end{itemlist}
	\item Skills and Knowledge \
		\begin{itemlist}
			\item Verilog circuit design skill
			\item Knowledge of FPGA architecture - consult with supervisor
			\item VPR interfacing - consult with graduate students
		\end{itemlist}
\end{itemlist}
