...
\begin{itemlist}
\item have enough logic elements to accommodate reasonable\note{quantify} test circuits,
\item work and fit\note{words not suck} on a commercially available FPGA.
\end{itemlist}
...
We will use standard\citationneeded benchmark circuits placed and routed using VPR.
...
\item the overlay FPGA can fit reasonable\note{ref} circuits
