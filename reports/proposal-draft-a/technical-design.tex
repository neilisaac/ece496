...
The main criterias are cost, size, and ease of use.
The lower the cost of the finished design to the reasercher, the better.
We must also ensure that the design is large enough to handle circuits the reaserchers wish to test.
