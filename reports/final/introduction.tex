...
\begin{itemlist}
	...
	\item Fit at least 100 overlay logic elements on the Virtex 5 FPGA.  This number was chosen to be adequately large for our proof of concept.  100 cells will fit our test circuits fit, and conceivable circuits can be implemented by participants at the design fair.
